        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                <!-- User profile -->
                <div class="user-profile" style="background: white; color: black;">
                    ...
                    <div class="profile-text" >
                        <div style="padding-left: 0px; padding-right: 0px; padding-bottom: 0px;">
                            <br>
                            <h2 style="text-align: center; font-weight: bold;">My Pannel</h2>
                ...
                <!-- Sidebar navigation-->
                <nav class="sidebar-nav" style="padding: 0px;">
                    <ul id="sidebarnav">
                        <li class="nav-small-cap">Actions Menu</li>
                        <li>
